...
namespace NetFlox.Controllers
{
    public class CelebritesController : Controller
    {
        ...
        // GET: Celebrites/Search
        public async Task<IActionResult> Search(string celebrite)
        {
            var films = await _context.Celebrites
                .Where(c => c.Nom.ToLower().Contains(celebrite.ToUpper()))
